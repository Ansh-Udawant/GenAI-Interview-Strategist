...
import { clearError, registerUser, setPendingEmail } from "../redux/slices/authSlice";

/**
 * User Registration Page Component handling initial account creation form and triggering email verification.
 *
      ...
      <div className={`w-full max-w-sm p-6 sm:p-8 rounded-xl border transition-all ${
        ...
        <div className="mb-6 text-center">
          ...
          <p className={`text-xs mt-1 ${isDark ? "text-zinc-400" : "text-zinc-500"}`}>
            Sign up for GenAI Interview Strategist
          </p>
        </div>
